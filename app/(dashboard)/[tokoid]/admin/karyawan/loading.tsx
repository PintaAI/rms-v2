          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-muted/50">
                <tr>
                  <th className="p-4 text-left text-xs font-semibold text-muted-foreground uppercase tracking-widest">Nama</th>
                  <th className="p-4 text-left text-xs font-semibold text-muted-foreground uppercase tracking-widest">Email</th>
                  <th className="p-4 text-left text-xs font-semibold text-muted-foreground uppercase tracking-widest">Role</th>
                  <th className="p-4 text-left text-xs font-semibold text-muted-foreground uppercase tracking-widest w-[80px]">Aksi</th>
                </tr>
              </thead>
              <tbody>
                <TableRowSkeleton />
