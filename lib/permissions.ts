...
export const PERMISSION_REGISTRY = {
  ...
  "inventory.manageRetail": {
    label: "Kelola aksesoris / barang retail",
    description: "Dapat membuat, mengubah, dan menghapus aksesoris atau barang retail di inventory.",
    inactiveReason: "Karyawan tidak dapat mengelola aksesoris atau barang retail inventory.",
    category: "retail",
    requiredFeature: "retail.sales",
    grantableInV1: true,
    sensitivity: "operational",
  ...
  "inventory.managePhoneUnits": {
    label: "Kelola katalog HP",
    description: "Dapat melihat, menambah, mengubah, dan menghapus unit HP di katalog inventory.",
    inactiveReason: "Karyawan tidak dapat mengelola katalog HP inventory.",
    category: "inventory",
    requiredFeature: "inventory.management",
    grantableInV1: true,
    sensitivity: "operational",
  ...
  "supplier_returns.view": {
    ...
    requiredFeature: "inventory.supplierReturns",
    grantableInV1: true,
    sensitivity: "operational",
  },
  ...
  "supplier_debts.view": {
    ...
    requiredFeature: "inventory.supplierDebts",
    grantableInV1: true,
    sensitivity: "sensitive",
  },
