...
export const MOCK_RETAIL_ITEMS: SparepartWithCompatibilities[] = [
  {
    id: "mock-retail-1",
    barcode: "CHG-20W-TC",
  ...
  },
  {
    id: "mock-retail-2",
    barcode: "CBL-LTG-1M",
    name: "Kabel Lightning 1 Meter",
    defaultPrice: 45000,
    purchasePrice: 25000,
    supplierName: "Supplier Preview B",
    categoryId: "mock-cat-cable",
    stock: 18,
    criticalStock: 6,
    isUniversal: true,
    kind: "retail_item",
  ...
  {
    id: "mock-retail-3",
    barcode: "CASE-IP15-BLK",
    name: "Softcase iPhone 15 Hitam",
    defaultPrice: 65000,
    purchasePrice: 32000,
    supplierName: "Supplier Preview C",
    categoryId: "mock-cat-case",
    stock: 9,
    criticalStock: 4,
    isUniversal: false,
    kind: "retail_item",
