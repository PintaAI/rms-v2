...
interface AdminRetailHistoryPageProps {
...
export default async function AdminRetailHistoryPage({ params, searchParams }: AdminRetailHistoryPageProps) {
...
async function RetailHistoryShell({ tokoId, filters, readOnly = false }: { tokoId: string; filters: RetailSalesFilters; readOnly?: boolean }) {
  ...
  return (
    <div className="flex flex-col gap-6 lg:gap-8">
      ...
      <RetailSalesHistory tokoId={tokoId} rolePath="admin" initialData={data} initialFilters={filters} />
    </div>
  )
}
