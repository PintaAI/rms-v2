...
export const ROLE_DEFAULT_COLUMNS: Record<string, ColumnList> = {
  admin: ["customer", "device", "complaint", "includedItems", "createdBy", "status", "technician", "invoice", "checkinAt"],
  staff: ["customer", "device", "complaint", "includedItems", "createdBy", "status", "invoice", "checkinAt"],
  technician: ["customer", "device", "complaint", "includedItems", "technician", "note", "status"],
  technicianMyTasks: ["customer", "device", "complaint", "includedItems", "note", "status"],
};
