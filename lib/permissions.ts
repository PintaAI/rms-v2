...
export const PERMISSION_REGISTRY = {
  ...
  "service.manageItems": {
    ...
    description: "Dapat menambah atau menghapus sparepart dan jasa pada invoice service.",
    inactiveReason: "Karyawan tidak dapat menambah atau menghapus sparepart dan jasa pada invoice service.",
    category: "service",
    requiredFeature: "service.management",
    grantableInV1: true,
    sensitivity: "operational",
  ...
  "supplier_returns.create": {
    ...
    description: "Dapat membuat data retur supplier dari sparepart atau klaim garansi.",
